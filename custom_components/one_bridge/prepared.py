...
from .models import PreparedMutation, SuiteBridgeError, digest_json
...
class PreparedMutationStore:
    ...
    async def create(
        ...
        *,
        ...
        # 24 random bytes = 192 bits of entropy before URL-safe encoding.
        prepare_id = f"mut-{secrets.token_urlsafe(24)}"
        digest = digest_json(
            {
